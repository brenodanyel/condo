			...
			<div class="flex flex-col min-h-full bg-white font-sans px-6">
				<div class="flex-1 flex flex-col justify-center">
					<div class="text-center mb-10">
						...
						>
							<ion-icon :icon="personAddOutline" class="text-white text-3xl"></ion-icon>
						</div>
						<h1 class="text-[28px] font-extrabold text-slate-900 tracking-tight">Criar Conta</h1>
						<p class="text-[14px] text-slate-400 mt-1">Junte-se ao CondoSmart</p>
					</div>
					...
					<div class="space-y-4">
						...
						<div class="text-center pt-1">
							<p class="text-[13px] text-slate-400">
								Já tem uma conta?
								<button @click="router.push('/login')" class="text-brand font-semibold ml-1">
									Entrar
								</button>
							</p>
						</div>
				...
				<p class="text-center text-[11px] text-slate-300 pb-8 pt-6">
					Ao cadastrar-se, você concorda com nossos<br />Termos de Uso e Política de Privacidade
				</p>
			</div>
		</ion-content>
	</ion-page>
